...
def dibujar_modelo_2d(modelo):
    ...
    # Izquierda (Frontal)
    fig.update_xaxes(title_text="<b>Eje X [m]</b>", range=[centro_x - 2.5, centro_x + 2.5], zeroline=True, row=1, col=1)
    fig.update_yaxes(title_text="<b>Eje Y (Altura) [m]</b>", range=[base_y_dampers - 0.1, base_y_dampers + 5.0], zeroline=True, row=1, col=1)
